...
public class HealthBar {
    ...
    private static final Identifier fullHealthBar = Identifier.of(FlareClient.MOD_ID, "textures/gui/healthbars/full.png");
//    private static final Identifier witherHealthBar = Identifier.of(FlareClient.MOD_ID, "textures/gui/healthbars/wither.png");
//    private static final Identifier poisonHealthBar = Identifier.of(FlareClient.MOD_ID, "textures/gui/healthbars/poison.png");
//    private static final Identifier frozenHealthBar = Identifier.of(FlareClient.MOD_ID, "textures/gui/healthbars/frozen.png");
    private Identifier currentBar = fullHealthBar;
    private static final Identifier intermediateHealthBar = Identifier.of(FlareClient.MOD_ID, "textures/gui/healthbars/intermediate.png");
    private static final Identifier emptyHealthBar = Identifier.of(FlareClient.MOD_ID, "textures/gui/healthbars/empty.png");
    private static final Identifier absorptionBar = Identifier.of(FlareClient.MOD_ID, "textures/gui/healthbars/absorption.png");
...
//        double health = Math.ceil(player.getHealth() * 10) / 10;
        Integer health = (int) Math.ceil((player.getHealth() / player.getMaxHealth()) * 100);

//        String text = health + "/" + (int) player.getMaxHealth();
        String text = health + "%";
        text = text.replace(".0", "");
        context.drawText(textRenderer, text, x - textRenderer.getWidth(text) - 6, y + 1, 0xFF0000, true);
    }
